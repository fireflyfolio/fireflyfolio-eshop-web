...
public class AuthController {
  private final JdbcAdminRepository repo; private final PasswordEncoder encoder;
  ...
  public ResponseEntity<Void> logout(HttpSession session){ session.invalidate(); return ResponseEntity.noContent().build(); }
  ...
  @GetMapping("/status")
  public String status(){ return "Hello dear manager"; }
}
