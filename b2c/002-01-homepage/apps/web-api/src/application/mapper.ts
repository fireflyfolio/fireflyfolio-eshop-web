...
export function localizePage(page: StaticPage, locale: Locale) { return { slug: page.slug, title: page.title[locale] ?? page.title.fr, html: page.html[locale] ?? page.html.fr }; }
